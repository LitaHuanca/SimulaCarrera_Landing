...
function HeroGeometric({
  ...
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-[#0D0820]">
      {/* Ambient gradient */}
      <div className="absolute inset-0 bg-gradient-to-br from-violet-500/[0.05] via-transparent to-purple-500/[0.05] blur-3xl" />

      {/* Floating shapes — paleta morada SimulaCarrera */}
      <div className="absolute inset-0 overflow-hidden">
        ...
        <ElegantShape
          ...
          height={80}
          rotate={-8}
          gradient="from-fuchsia-500/[0.10]"
        ...
        <ElegantShape
          ...
          height={35}
          rotate={15}
          gradient="from-fuchsia-400/[0.08]"
          className="right-[35%] bottom-[15%]"
        />
      </div>

      {/* Contenido — pasado como children para máxima flexibilidad */}
      ...
      {/* Fade top/bottom */}
      <div className="absolute inset-0 bg-gradient-to-t from-[#0D0820] via-transparent to-[#0D0820]/80 pointer-events-none" />
    </div>
  )
}
